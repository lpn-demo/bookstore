				...
				<div className="card text-center m-3">
					<div className="card-footer pb-0 pt-3">
						...
						<ul className="pagination justify-content-center" >
							<li className={`page-item first-item ${props.currentPage === 1 ? 'disabled' : ''} ${styles.hide}`}>
							...
							<li className={`page-item previous-item ${props.currentPage === 1 ? 'disabled' : ''}`}>
								...
								<span className={styles.show}>
									<props.linkComponent to={urlBuilder('home', { id: props.currentPage - 1 })} className="page-link">{'<'}</props.linkComponent>
								</span>
							</li>
							...
							<li className={`page-item next-item ${props.currentPage === props.totalPages ? 'disabled' : ''}`}>
								...
								<span className={styles.show}>
									<props.linkComponent to={urlBuilder('home', { id: 2 })} className="page-link">{'>'}</props.linkComponent>
								</span>
							</li>
							<li className={`page-item last-item ${props.currentPage === props.totalPages ? 'disabled' : ''} ${styles.hide}`}>
